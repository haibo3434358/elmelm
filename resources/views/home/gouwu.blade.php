...
<html class="no-js" lang="zh">
 <head> 
  ...
  <link class="usemin" rel="stylesheet" href="/home/home/css/order.58f4e423.css" />
...
//    if(!window.CDNReady){var d=new Date;d.setHours(d.getHours()+6);document.cookie='CDNDown=1; domain=v5.ele.me; expires='+d.toUTCString()+'; path=/';if(!window.localStorage.getItem('CDNBackup')){window.localStorage.setItem('CDNBackup',1);location.reload(true)}}
  ...
  <script class="usemin" src="/home/js/modernizr.custom.min.f49cdc05.js"></script>
  <script>
...
"> 
  <div class="container"> 
   <header class="cart-topbar group"> 
    ...
    <div class="ctopbar-breadcrumb" role="navigation"> 
     <a class="ctopbar-nav rst" target="_blank" href="#">{{$shangjia->exname}}</a>
    ...
    <div class="eleme_dropdown ctopbar-usernav"> 
     ...
     <ul class="e_dropdown topbar-user-dropdown ctopbar-dropdown"> 
      <li><a class="tuser-link" href="#"><i class="glyph-user"></i>个人中心</a></li>
      <li><a class="tuser-link" href="#"><i class="glyph-fav"></i>我的收藏</a></li>
      <li><a class="tuser-link" href=#"><i class="glyph-location"></i>我的地址</a></li>
      <li><a class="tuser-link" href="#"><i class="glyph-config"></i>安全设置</a></li>
      <li class="divider"></li> 
      <li><a id="topbar_logout" class="tuser-link" href="#"><i class="glyph-off"></i>退出登录</a></li>
     </ul> 
    </div> 
   </header>
   ...
   <div id="cart_wrap" class="cart-container cart-checkout">
    <header class="checkout-header">
     <div id="restaurant" class="group" data-restaurant="178405" data-geo="-614966279988955594" data-olpayment="1">
      <a class="crst-logo" target="_blank" href="#" title="臻好时酸奶自助冰淇淋"> <img class="crst-img" src="/home/home/images/9155eb84f086c98b6f3e66531b4c0gif.gif" /> </a>
      <div class="crst-info">
       <a class="crst-name" target="_blank" title="臻好时酸奶自助冰淇淋" href="#">{{$shangjia->exname}}</a>
       <p class="crst-flavor">{{$shangjia->type}}</p>
      </div>
     </div>
     <ol class="cart-flow">
  ...
  {{--<script>--}}
    ...
    {{--}();--}}
    {{--</script> --}}
  <script class="usemin" src="/home/home/js/checkout.6df4491e.js"></script>
 </body>
</html>
...
<html ng-app="eleme" perf-error="desktop/" class="ng-scope"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\:form{display:block;}.ng-animate-block-transitions{transition:0s all!important;-webkit-transition:0s all!important;}.ng-hide-add-active,.ng-hide-remove{display:block!important;}</style>
    ...
    <script src="/home/elm/api" data-ref="API_CONFIG"></script>
    <script src="D:/Desktop/project/www.ele.me/www.elm.com/js/perf.js" type="text/javascript" ></script>
    <script src="/home/js/vendor.6b3834.js" type="text/javascript" ></script>
    <script src="/home/js/222.js" type="text/javascript" ></script>
    <script src="/home/js/1111.js"></script>
    {{--<script src="/admin/js/jquery.js">--}}
    <!--<base href="/">s-->
    <base href=".">
  <meta name="mobile-agent" content="format=html5;url=https://h5.ele.me/shop/#id=1195106"><meta name="description" content="田老师红烧肉（怀柔青春路店）位于北京市怀柔区青春路15号一层的住所南起第三间门店，主要美食有单个狮子头、烤肠(根)、单份米饭、卤蛋(个)、红烧肉+番茄鸡蛋等，了解更多美食外卖，上饿了么网上订餐"><meta name="keywords" content="田老师红烧肉（怀柔青春路店）外卖，田老师红烧肉（怀柔青春路店）菜单，田老师红烧肉（怀柔青春路店）电话"></head>
                      ...
                      <div class="topbar-nav-link">
                          ...
                          <div class="dropbox topbar-mobile-dropbox">
                            <span>
                              ...
                              <img src="./elm/appqc.95e532.png" class="topbar-nav-qrcode" alt="扫一扫下载饿了么手机 App">
                          </div>
                      </div>
              ...
              <div class="toolbar-btn icon-QR-code">
                  <div class="dropbox toolbar-tabs-dropbox">
                      <a href="http://static11.elemecdn.com/eleme/desktop/mobile/index.html"
                         target="_blank">
                          <img src="./elm/appqc.95e532.png" alt="下载手机应用">
                          <p>
                              下载手机应用
                          </p>
  ...
  <div ng-view="" role="main" class="ng-scope">
          ...
          <div class="container" ng-show="shop" itemscope="" itemtype="http://schema.org/Restaurant">
              <div class="shopguide-info">
                  ...
                  <div class="shopguide-info-wrapper">
                      <div>
                          <h1 title="田老师红烧肉（怀柔青春路店）" ng-class="{hastip: shop.tip}" itemprop="name"
                              class="ng-binding">
                              {{$saleuser->exname}}
                          </h1>
                          <!-- ngIf: shop.tip -->
                      ...
                      (
                      <a ng-href="/shop/1195106/rate" class="ng-binding" href="https://www.ele.me/shop/1195106/rate">
                          456
                      </a>
                      )
          ...
          <div class="shopnav">
              <div class="container clearfix">
                  <div class="shopnav-left">
                      <a class="shopnav-tab active" href="https://www.ele.me/shop/1195106" ng-class="{active: shop.tab === &#39;index&#39;}">
                          所有商品
                      </a>
                      <a class="shopnav-tab" href="https://www.ele.me/shop/1195106/rate" ng-class="{active: shop.tab === &#39;rate&#39;}">
                          评价
                      </a>
                      <a class="shopnav-tab" href="https://www.ele.me/shop/1195106/info" ng-class="{active: shop.tab === &#39;info&#39;}">
                          商家资质
                      </a>
     ...
     <a href="javascript:" ng-click="filter(&#39;-rating&#39;)" ng-class="{active: filterData === &#39;-rating&#39;}">评分 <i class="icon-uniE02D"></i></a> 


     <a href="javascript:" ng-click="filter(&#39;-month_sales&#39;)" ng-class="{active: filterData === &#39;-month_sales&#39;}">销量 <i class="icon-uniE02D"></i></a>


     <a href="javascript:" ng-click="filter(&#39;-price&#39;)" ng-class="{active: filterData === &#39;-price&#39; || filterData === &#39;price&#39;}">价格 <i class="icon-uniE02D" ng-hide="filterData === &#39;price&#39;"></i> 
...
<span>
    ...
    <a class="shopnav-filter-display icon-list" href="javascript:" title="以列表形式显示菜单"
      ...
      <div class="shopmain clearfix container ng-scope" style="width:1160px;margin-left:105px;">
          <!-- ngIf: shopAction===' menu' -->
          <div ng-if="shopAction === &#39;menu&#39;" shop-menu="" shop-cache="shopCache"
              ...
              <div class="loading ng-binding ng-isolate-scope ng-hide" loading="" ng-show="loading">
                  <!-- ngIf: type==='profile' -->
                  <img ng-if="type===&#39;profile&#39;" src="./elm/profile-loading.4984fa.gif"
              ...
              <div ng-show="!loading &amp;&amp; !searchEnv" class="shopmenu-nav ng-isolate-scope"
                  ...
                  <a href="javascript:" ng-repeat="category in categorys" ng-click="scrollToCategory(category)"
                     ng-class="{active: currentCategory.id === category.id}" class="ng-binding ng-scope">
                      {{$v->gfl}}
                  </a>
                  @endforeach
                  <!-- end ngRepeat: category in categorys -->
    {{--<a href="javascript:" ng-repeat="category in categorys" ng-click="scrollToCategory(category)" ng-class="{active: currentCategory.id === category.id}" class="ng-binding ng-scope">盖饭</a><!-- end ngRepeat: category in categorys -->--}}
              </div>

    <div ng-show="!loading" class="shopmenu-main grid" ng-class="{grid: displayType === &#39;grid&#39;, list: displayType === &#39;list&#39;}"><!-- ngIf: filterData === 'default' && !searchEnv -->
    <div ng-if="filterData === &#39;default&#39; &amp;&amp; !searchEnv" class="ng-scope"><!-- ngRepeat: category in categorys -->
        @foreach($grr as $k=>$v)
    <div class="shopmenu-list clearfix ng-scope" ng-repeat="category in categorys">
        {{--@foreach($goodgfl as $m=>$n)--}}
        {{--<h3 class="shopmenu-title ng-binding">{{$n->gfl}}</h3><!-- ngRepeat: food in category.foods -->--}}

            @foreach($v as $kk=>$vv)
            <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}"
                 id="626104394" ng-repeat="food in category.foods" shop-menu-item="" food="food"
                 shop="shopCache">
                <!-- ngIf: food.image_path -->
                <span class="col-1 ng-scope" ng-if="food.image_path">
        <a href="javascript:" ng-click="showInfo(food)">
            <img ng-src="//fuss10.elemecdn.com/d/7c/6940261e9231d507a67ba49300f4cjpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85"
                 alt="单个狮子头的图片" src="{{$vv->gpic}}">
        </a>
    </span>
                ...
                <div class="col-2 shopmenu-food-main">
                    ...
                    <p class="color-mute ui-ellipsis ng-binding"  id="gname">
                        {{$vv->gname}}
                    </p>
                    <p>
        ...
        <div shop-cartbutton="" food="food" ng-hide="shop.id == &#39;656683&#39;"
            ...
            <div ng-if="!menuFood.hasSpec" class="ng-scope">
                ...
                <p class="shop-cartbutton ng-binding ng-scope" onclick="gouwuche({{$vv->gid}})">
                    加入购物车
                </p>
                {{--ng-if="!cartItem.quantity &amp;&amp; menuFood.stock"--}}
                        {{--ng-click="cartItem.add($event)"--}}
...
//                  function post( data)
//                   {
//                      $("#yeye").append("<form></form>");
//                      $("#yeye").find("form").attr("action",);
//                      $("#yeye").find("form").attr("method","post");
////                      $("#yeye").find("form").attr("display","none");
//
//                          $("#yeye").find("form").append('<input id="ggid" type="text" value='+data[0].gid+'><input id="ggid" type="text" value='+data[0].gname+'><input id="ggid" type="text" value='+data[0].gprice+'>');
//
//                      $("#yeye").find("form").submit();
//                  }
...
//                            anim: 2,
////                            time: 6000, //2秒后自动关闭
//                            content:'<table style="border:1px;color:black; ">'+
//                            '<div  id="yeye" width="350px">'+
//                            '<form action="" method="post" style="width:570px">'+
//
//                            '</form>'+
//                            '<button>提交</button>'+
//                            '</div>'+
...
//                        });
//                            alert(id);
                        {{--$.post("{{url('home/session')}}",{'_token':'{{csrf_token()}}','id':'id'},function(data){--}}
                                            {{--alert(data);--}}
                    {{--})--}}
//                            var id = $id;
                        $.post("{{url('home/session/')}}/"+id,{'_token':'{{csrf_token()}}'},function(data){
//                            function gouwuche(id)
//                            {
//                                layer.open({
//                                    type: 1,
...
//                                });
                            layer.alert('成功加入购物车');
//                            console.log(data);
//                            $('#yeye').append().html('<tr></tr>')
//                            $('#yeye').find("tr").append('<input id="ggid" type="text" value='+data[0].gid+'><input id="ggid" type="text" value='+data[0].gname+'><input id="ggid" type="text" value='+data[0].gprice+'>');
//                            $('#yeye tr').append().html('<input id="ggid" type="text" value='+data[0].gname+'>') ;
//                            $('#yeye tr').append().html('<input id="ggid" type="text" value='+data[0].gprice+'>') ;
//                               alert ('1111');
//                                post(data);
...
//                                </div>
                            ...
                            $("#yeye").find("form").append('<div class="row"><div class="col-xs-2"><input id="ggid" class="form-control" type="text" nama="fen" value='+'1份'+'></div><div class="col-xs-4"><input id="ggid" class="form-control" name="gname" type="text" value='+data[0].gname+'></div><div class="col-xs-2"><input name="gprice" class="form-control" type="text" value='+data[0].gprice+'></div></div>');
//
//                            $("#yeye").find("form").html('<input  type="button" value="提交">');
                    ...
                    <div class="shop-iteminfo">
                        ...
                        <section class="iteminfo-info">
                            ...
                            <span class="price">
                                ...
                                <span class="price ng-binding" ng-bind="(itemInfo.original_price || itemInfo.price) + (itemInfo.specfoods_id.length &gt; 1 ? &#39;起&#39; : &#39;&#39;)">
                                </span>
                            </span>
                                </div>
                                <!-- ngIf: itemInfo.name -->
              ...
              <div class="shopbulletin">
                  ...
                  <table class="">
                      <div  id="yeye" width="350px">
                          ...
                          <form id="xx" action="{{url('home/session/gouwu/')}}" method="post" style="width:570px" onsubmit="return false;">


                              {{csrf_field()}}
                          <a href="{{url('home/session/gouwu/'.$saleuser->sxid)}}"><input for="xx" type="button" class="btn btn-success" value="去购物车结算" /></a>
                              {{--<button>结算</button>--}}
                          </form>
                      </div>
                  </table>
...
//                          document.forms[0].submit();
      ...
      <div class="sidetools" side-tools="">
          ...
          <div class="sidetools-item icon-qrcode">
              <img class="sidetools-qrcode" src="./elm/appqc.95e532.png" alt="扫描二维码免费下载手机App">
          </div>
  ...
  <footer class="footer" role="contentinfo">
      <div class="container clearfix">
              ...
              <div class="footer-contect-item">
                  ...
                  <div href="JavaScript:" class="icon-wechat" ubt-click="402">
                      <div class="dropbox dropbox-bottom footer-contect-dropbox" ubt-visit="402">
                          <img src="./elm/wexinqc100@2x.393ade.png" alt="微信号: elemeorder">
                          <p>
                              微信号: elemeorder
                          </p>
                          <p>
          ...
          <div class="footer-mobile">
              <a href="https://h.ele.me/landing" target="_blank">
                  <img src="./elm/appqc.95e532.png" class="footer-mobile-icon" alt="扫一扫下载饿了么手机 App">
              </a>
          ...
          <div class="footer-police container">
              <a href="http://www.zx110.org/picp/?sn=310100103568" rel="nofollow" target="_blank">
                  <img alt="已通过沪公网备案，备案号 310100103568" src="./elm/picp_bg.e373b3.jpg" height="30">
              </a>
          </div>
      </div>
  </footer>
    ...
    <script src="/home/elm/home"></script>
  
  

<script src="/home/js/textStatic.js"></script><script src="/home/js/textStatic.js"></script><script src="/home/js/textStatic.js"></script></body></html>
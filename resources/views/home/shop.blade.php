                ...
                <div class="shopguide-info-extra">
                    <ul>
                        ...
                        <li class="shopguide-extra-item ng-binding ng-scope" ng-if="shop.description"
                            ...
                            田老师红烧肉，属于食堂型快餐连锁店。主营盖饭，种类虽“不多”，口味蛮“家常”，且配菜丰富。主菜里招牌红烧肉果然名不虚传，鱼香肉丝、酸豆角等也都不错。出菜速度快，价格又实惠！
                        </li>
                            ...
                            <span class="col-4">
                                        <div shop-cartbutton="" food="food" ng-hide="shop.id == &#39;656683&#39;"
                                            ...
                                            <div ng-if="!menuFood.hasSpec" class="ng-scope">
                                                ...
                                                <button onclick="jia({{$vv->gid}})" class="shop-cartbutton ng-binding ng-scope" ng-if="!cartItem.quantity &amp;&amp; menuFood.stock"
...
//            判断用户是否登录,没登录就先去登录
                    ...
                    $.post("{{url('home/shop/')}}/"+gid,{'_token':'{{csrf_token()}}'},function(data) {
//                console.log(data);
                        if (data.status == 2) {
                            alert('您还没有登录,请先登录!');
            ...
            function jian(go_id) {
                $.post("{{url('home/shop/jian')}}/" + go_id, {'_token': '{{csrf_token()}}'}, function (data) {
//                    console.log(data);
                    if (data.status == 0){
                        location.href = location.href;
            ...
            <div class="shopbulletin">
                <div class="shopbulletin-section">
                    ...
                    <p class="shopbulletin-content ng-binding">
                        近几日大雨，请提前订餐。骑手小哥送餐有一定难度，有可能会时间稍长一些。当餐品送达后，请给个好评。
                    </p>
    ...
    <div style="float:right;">
        ...
        <form class="form-inline" action="{{url('home/order')}}">
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputName1"  style="width:50px;" value="{{$v->goods_count}}">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label for="exampleInputEmail2"> 商品名  </label>
                            <input type="email" class="form-control" id="exampleInputEmail2" style="width:130px;" value="{{$v->goods_name}}">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label for="exampleInputEmail2">单价   </label>
                            <input type="email" class="form-control" id="exampleInputEmail2" style="width:50px;" value="{{$v->goods_price}}">
                        </div>
                    </td>
                    <td>
                        <button type="button" class="btn btn-primary btn-sm active" onclick="jian({{$v->go_id}})">-</button>
                    </td>
                </tr>
                @endforeach

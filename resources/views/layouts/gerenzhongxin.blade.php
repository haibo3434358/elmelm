<!DOCTYPE html>
<!-- saved from url=(0035)https://www.ele.me/profile/security -->
...
<head>
    ...
    <![endif]-->
    <script src="/home/js/api" data-ref="API_CONFIG">
    </script>
    <script src="/home/js/perf.js" type="text/javascript"
            crossorigin="anonymous">
    </script>
    <script src="/home/js/vendor.0df01e.js" type="text/javascript"
            crossorigin="anonymous">
    </script>
    <script src="/home/js/profile.fb1b4e.js" type="text/javascript"
            crossorigin="anonymous">
    </script>
    <style>
        .security-type-name {
    ...
    <link rel="stylesheet" type="text/css" href="/home/date/tcal.css" />
    <script type="text/javascript" src="/home/date/tcal.js"></script>
    <!--<base href="/profile/">-->
    <base href=".">
...
<body cute-title="" ng-class="{hidesidebar: layoutState &amp;&amp; layoutState.hideSidebar, smallbody: layoutState.smallBody, whitebody: layoutState.whiteBody}"
      lim:visitorcapacity="1" style="position: relative;">
                ...
                <nav class="topbar-nav">
                    ...
                    <div class="topbar-nav-link">
                        ...
                        <div class="dropbox topbar-mobile-dropbox">
                            ...
                            <link href="/home/img/appqc.95e532.png" class="topbar-nav-qrcode"
                                  alt="扫一扫下载饿了么手机 App">
                        </div>
                    </div>
                    <div topbar-profilebox="">
                        <div class="topbar-profilebox">
                            ...
                            {{--<img class="topbar-profilebox-avatar ng-scope" ng-src="//fuss10.elemecdn.com/1/aa/517c48e40061040af3a2b6a96bf94jpeg.jpeg?imageMogr2/thumbnail/26x26/format/webp/quality/85"--}}
                                 {{--ng-if="$root.user.avatar &amp;&amp; $root.topbarType !== &#39;checkout&#39;"--}}
                                 {{--alt="个人头像" src="./个人中心_安全中心 _ 饿了么网上订餐_files/517c48e40061040af3a2b6a96bf94jpeg.jpeg">--}}
                            ...
                            <span ng-show="!$root.user.username" class="ng-hide">
                                        <a ng-href="//h5.ele.me//login/#redirect=https%3A%2F%2Fwww.ele.me%2Fprofile%2Faddress"
                                           target="_blank" href="https://h5.ele.me//login/#redirect=https%3A%2F%2Fwww.ele.me%2Fprofile%2Faddress">
                                            登录/注册
                                        </a>
                                    </span>
            ...
            <div class="toolbar-btn icon-QR-code">
                <div class="dropbox toolbar-tabs-dropbox">
                    <a href="http://static11.elemecdn.com/eleme/desktop/mobile/index.html"
                       target="_blank">
                        <link href="/home/img/appqc.95e532.png" alt="下载手机应用">
                        <p>
                            下载手机应用
                        </p>
    ...
    <div class="profile-container container" profile-container="" page-name="security-center"
        ...
        <ul class="profile-sidebar" role="navigation" profile-sidebar="">
            ...
            <li class="profile-sidebar-section">
                ...
                <ul>
                    <li >
                        <a onclick="ziliao()" href="">
                            个人资料
                        </a>
                    </li>
                    <li >
                        <a   onclick="address()" href="">
                            地址管理
                        </a>
                    </li>
                    <li >
                        <a  onclick="modifypass()" href="">
                            修改密码
                        </a>
                    </li>
                </ul>
...
//    我的优惠券
function yhq(){
    location.href = "{{url('/home/gerenzhongxin')}}";
}
//我的订单
function order()
{
...
//    我的资料
   function ziliao(){
       location.href = "{{url('/home/ziliao')}}";
   }
   function address(){
       location.href = "{{url('/home/address')}}";
   }
   function modifypass(){
       location.href = "{{url('/home/modifypass')}}";
   }
</script>
    ...
    <div class="container clearfix">
            ...
            <div class="footer-contect-item">
                ...
                <div href="JavaScript:" class="icon-wechat" ubt-click="402">
                    <div class="dropbox dropbox-bottom footer-contect-dropbox" ubt-visit="402">
                        <link href="./img/wexinqc100@2x.393ade.png" alt="微信号: elemeorder">
                        <p>
                            微信号: elemeorder
                        </p>
                        <p>
        ...
        <div class="footer-mobile">
            <a href="https://h.ele.me/landing" target="_blank">
                <link href="/home/img/appqc.95e532.png" class="footer-mobile-icon"
                      alt="扫一扫下载饿了么手机 App">
            </a>
        ...
        <div class="footer-police container">
            <a href="http://www.zx110.org/picp/?sn=310100103568" rel="nofollow" target="_blank">
                <img alt="已通过沪公网备案，备案号 310100103568" src="./个人中心_安全中心 _ 饿了么网上订餐_files/picp_bg.e373b3.jpg"
                     height="30">
            </a>
        </div>
    </div>

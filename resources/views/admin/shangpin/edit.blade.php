...
@section('content')
    <div class="rt_content">
        ...
        @endif
        <section>
            <form action="{{url('admin/shangpin/'.$dd->gid)}}" enctype="multipart/form-data" method="post">
            <ul class="ulColumn2">
                {{method_field('put')}}
                {{csrf_field()}}
                <li>
                    <span class="item_name" style="width:120px;">菜品名称：</span>
                    <input type="text" class="textbox textbox_295"  value="{{$dd->gname}}" name="gname" placeholder="请输入菜品名称..."/>
                    <span class="errorTips">请不要超过10个汉子...</span>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">商品价格：</span>
                    <input type="text" class="textbox" name="gprice" value="{{$dd->gprice}}"  placeholder="请输入商品价格..."/>
                    <span class="errorTips">必须输入...</span>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">菜品规格：</span>
                    <input type="text" class="textbox" name="gstandard"  value="{{$dd->gstandard}}" placeholder="请输入菜品规格..."/>
                    <span class="errorTips">宽*高...</span>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">菜品味道：</span>
                    <input type="text" class="textbox" name="gtaste" value="{{$dd->gtaste}}"  placeholder="请输入菜品味道..."/>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">菜品推销类型：</span>
                    <input type="text" class="textbox" name="gfl"  value="{{$dd->gfl}}" placeholder="请输入菜品推销类型..."/>
...
{{--//                                        本地服务器--}}
                ...
                <li>
                    ...
                    <input type="submit" class="link_btn" value="修改商品"/>
                </li>
            </ul>
            </form>
        </section>
